---
id: THP-PH-003
title: Values, Principles, Will, and Responsibility
...
related_documents:
  ...
  - ./THP-EPISTEMOLOGY.md
  - ../03-methods/entity-assessment/ENTITY-VALUES-PRINCIPLES-LOOP.md
  - ../03-methods/entity-assessment/ENTITY-ENGAGEMENT-BOUNDARIES.md
  - ../../philosophy/preliminary-questions/PH-003.md
supersedes: []
superseded_by: []
---
...
Operational assessment methods: [`../03-methods/entity-assessment/`](../03-methods/entity-assessment/).
...
**Distinction:** Values are stable but revisable. They are not unchangeable beliefs, branding adjectives, or styles of presentation.
...
**Distinction:** Measurement is not proof of valuation. Tracking a metric does not establish that the underlying subject is genuinely prioritized.
...
**Distinction:** Context informs decisions but does not take responsibility for them.
...
**Distinction:** Harmony does not erase genuine trade-offs.
...
**Distinction:** Will is not equated with constant growth, productivity, or absence of friction.
...
**Distinction:** Organizational values require institutional structures — public expression alone is insufficient.
...
**Distinction:** THP's authority depends on consent and defined scope. Access to private information does not itself grant authority.
...
Operational refusal conditions: [`ENTITY-ENGAGEMENT-BOUNDARIES.md`](../03-methods/entity-assessment/ENTITY-ENGAGEMENT-BOUNDARIES.md).
...
Operational method: [`ENTITY-VALUES-PRINCIPLES-LOOP.md`](../03-methods/entity-assessment/ENTITY-VALUES-PRINCIPLES-LOOP.md).
...
- Consolidated founder forms THP-PH-003 and THP-PH-003B into candidate institutional position.
- Registered as non-canonical philosophical foundation.
