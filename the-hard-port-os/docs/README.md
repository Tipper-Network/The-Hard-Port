...
related_documents:
  ...
  - ./00-foundations/THP-FOUNDATIONAL-PHILOSOPHY.md
  - ./00-foundations/THP-INSTITUTIONAL-PURPOSE-AND-BOUNDARIES.md
  - ./00-foundations/THP-EPISTEMOLOGY.md
...
Operational and methodological documentation for The Hard Port OS.
...
- [THP Foundational Philosophy](./00-foundations/THP-FOUNDATIONAL-PHILOSOPHY.md)  
  Defines the philosophical assumptions inherited by THP research, operations, media, consulting, and system design.

- [THP Institutional Purpose and Boundaries](./00-foundations/THP-INSTITUTIONAL-PURPOSE-AND-BOUNDARIES.md)  
  Defines what THP is as an institution, what it produces, what it must not become, and where philosophy ends and institutional action begins.

- [THP Epistemology](./00-foundations/THP-EPISTEMOLOGY.md)  
  Defines how THP understands knowledge — models, confidence, scope, revisability, and institutional skepticism.

- [Reality, Interpretation, and the Shared World](./00-foundations/THP-REALITY-INTERPRETATION-SHARED-WORLD.md)  
  Candidate position on external conditions, experience, interpretation, facts, truth, and expression.

- [The Self, Intention, and Expression](./00-foundations/THP-SELF-INTENTION-EXPRESSION.md)  
  Candidate position on self, intention, expression, organizational identity, consent, and THP's role.
...
These remain the source for lifecycle structure and concept definitions:

- [Knowledge Architecture (ARCH-KNOWLEDGE-001)](../KNOWLEDGE_ARCHITECTURE.md)
- [Document Metadata Standard](../templates/DOCUMENT_METADATA_STANDARD.md)
