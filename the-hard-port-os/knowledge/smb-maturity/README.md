...
Seven-level SMB maturity model with eight assessment dimensions and weakest-gate classification logic.
...
- **Level 1 — Established but Surviving**  
  Founder decisions confirmed · Ready for operationalization  
...
- **Level 2 — Stable and Preparing for Growth**  
  Founder decisions confirmed · Defines the destination of THP's first intervention  
...
- **Level 3 — Attempting Growth, Growth Model Not Yet Stable**  
  Founder direction confirmed · Defines the stage immediately following the first intervention  
  Detail: [`THP-SMB-LEVEL-03-attempting-growth.md`](./levels/THP-SMB-LEVEL-03-attempting-growth.md)

- **Levels 4–7**  
  Provisional · Detailed development deferred  
  Labels: [maturity model § Levels 4–7](./THP-SMB-LEVELS-001-maturity-model.md#levels-47-provisional)
...
- [THP-SMB-002 — Level 1 to Level 2 Transition](../active/forms/THP-SMB-002-level-1-to-level-2-transition.md)

## Prior sketch (superseded for SMB path)

[`docs/02-ontology/entity-maturity/ENTITY-MATURITY-MODEL.md`](../docs/02-ontology/entity-maturity/ENTITY-MATURITY-MODEL.md) — retained for provenance; use `THP-SMB-LEVELS-001` for all SMB classification work.
