...
export function GapSection() {
  return (
    <section id="gap" className="bg-depth-3 px-6 py-20 lg:px-12 lg:py-28">
      <div className="mx-auto max-w-hero">
        ...
        <div className="mt-14 grid items-stretch gap-3 md:grid-cols-[minmax(0,0.85fr)_minmax(0,1.5fr)_minmax(0,0.85fr)] md:gap-4 lg:grid-cols-[minmax(0,0.75fr)_minmax(0,1.75fr)_minmax(0,0.75fr)]">
          <div className="border border-secondary/15 bg-secondary/5 p-5 md:p-6">
            ...
            <ul className="mt-4 space-y-2.5">
              {now.map((item) => (
                <li
                  key={item}
                  className="flex gap-2 text-sm leading-5 text-secondary/60"
                >
          ...
          <div className="flex flex-col justify-center border border-accent bg-depth-4 px-6 py-8 shadow-[0_0_0_1px_var(--color-accent)] md:px-8 md:py-10">
          ...
          <div className="border border-accent bg-depth-4 p-5 shadow-[0_0_0_1px_var(--color-accent)] md:p-6">
